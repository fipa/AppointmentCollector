...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { calendar_key: @calendar.calendar_key, comments: @calendar.comments, name: @calendar.name, user_id: @calendar.user_id }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { calendar_key: @calendar.calendar_key, comments: @calendar.comments, name: @calendar.name, user_id: @calendar.user_id }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
